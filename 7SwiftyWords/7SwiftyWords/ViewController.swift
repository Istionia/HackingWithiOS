...
//  7SwiftyWords
//
//  Created by Timothy on 18/05/2023.
//
...
class ViewController: UIViewController {
    ...
    // As you can see, this code clears out the existing solutions array before refilling it inside loadLevel(). Then of course you'd need to create level2.txt, level3.txt and so on.
